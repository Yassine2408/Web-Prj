...
import { BadgeCheck, Cpu, MapPin, ShieldCheck, Smartphone, Wrench } from "lucide-react";
    ...
    <div className="space-y-16 md:space-y-20">
      <section className="sitara-hero">
        ...
        <div className="mt-6 flex flex-wrap gap-2.5">
          <span className="inline-flex items-center gap-1.5 rounded-full border border-border/80 bg-background/70 px-3 py-1 text-xs text-muted-foreground backdrop-blur-sm">
            <ShieldCheck className="h-3.5 w-3.5 text-primary" />
            {t(locale, "Build secure et maintenable", "بنية آمنة وقابلة للصيانة")}
          </span>
          <span className="inline-flex items-center gap-1.5 rounded-full border border-border/80 bg-background/70 px-3 py-1 text-xs text-muted-foreground backdrop-blur-sm">
            <Cpu className="h-3.5 w-3.5 text-primary" />
            {t(locale, "Stack moderne Next.js + SEO", "تقنيات حديثة Next.js + SEO")}
          </span>
        </div>
      </section>
